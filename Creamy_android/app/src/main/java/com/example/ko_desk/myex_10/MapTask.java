...
import com.example.ko_desk.myex_10.VO.MemberVO;
...
public class MapTask extends AsyncTask<Map, Integer, String> {
    ...
    protected void onPostExecute(String s) {
        ...
        // gson이 역직렬화하는 코드
        MemberVO mem = gson.fromJson(s, MemberVO.class);
        Log.d("JSON_RESULT", mem.getUser_id());
        Log.d("JSON_RESULT", mem.getUser_password());
    }
}
